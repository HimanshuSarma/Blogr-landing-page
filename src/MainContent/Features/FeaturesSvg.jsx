  ...
  return (
    ...
    >
      <defs>
        ...
        <rect id="prefix__b" x={0} y={0} width={506} height={335.872} rx={3} />
        <path
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <rect
          ...
          rx={275}
        />
        <g transform="translate(190 192)" filter="url(#prefix__a)">
          <rect
            fill="#535353"
            fillRule="nonzero"
            x={82}
          ...
          <g transform="translate(99 32)">
            ...
            <rect
              ...
              rx={3}
            />
            <g mask="url(#prefix__d)" fillRule="nonzero">
          ...
          <g transform="translate(0 380)">
            ...
            <use fill="#52526F" fillRule="nonzero" xlinkHref="#prefix__e" />
            <rect
              fill="#2F2F47"
              fillRule="nonzero"
              mask="url(#prefix__f)"
